          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input id="name" required {...field('name')} placeholder="e.g., Handmade Chocolate Box" />
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <Select value={formData.origin} onValueChange={v => setFormData(p => ({ ...p, origin: v as any }))}>
              ...
              <div className="space-y-2">
                ...
                <Input id="price" type="number" step="0.01" required {...field('price')} placeholder="999.00" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="discountPrice">Discount Price (₹)</Label>
                <Input id="discountPrice" type="number" step="0.01" {...field('discountPrice')} placeholder="799.00" />
              </div>
              <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <Textarea id="description" rows={4} {...field('description')} placeholder="Detailed product description..." />
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <Label htmlFor="images" className="cursor-pointer">
              ...
              <Input id="images" type="file" multiple accept="image/*" className="hidden" onChange={handleImageUpload} disabled={uploading} />
            </Label>
            {formData.images.length > 0 && (
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {formData.images.map((img, i) => (
                  <div key={i} className="relative group">
                    <img src={img} alt={`Product ${i + 1}`} className="w-full h-32 object-cover rounded-lg" />
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Textarea id="ingredients" rows={3} {...field('ingredients')} placeholder="Water&#10;Glycerin&#10;..." />
            </div>
            <div className="space-y-2">
              <Label htmlFor="benefits">Benefits (one per line)</Label>
              <Textarea id="benefits" rows={3} {...field('benefits')} placeholder="Moisturizes skin&#10;..." />
            </div>
            <div className="space-y-2">
              <Label htmlFor="usage">How to Use</Label>
              <Textarea id="usage" rows={3} {...field('usage')} placeholder="Apply twice daily..." />
            </div>
            <div className="space-y-2">
              <Label htmlFor="suitableFor">Suitable For (comma-separated)</Label>
              <Input id="suitableFor" {...field('suitableFor')} placeholder="All skin types, Sensitive skin" />
            </div>
          </CardContent>
        </Card>
