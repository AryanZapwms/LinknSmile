...
export async function POST() {
  ...
  try {
    ...
    const categories = await Category.find({ isActive: true }).populate("company");
    ...
    const products = [
      ...
      },
      {
        ...
        description: "Professional-grade glycolic acid serum for radiant, glowing skin",
        price: 1899,
        discountPrice: 1519,
        image:
          "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=400&h=400&fit=crop&crop=center",
        ...
        stock: 30,
        sku: "IP-GG-002",
        ingredients: ["Glycolic Acid", "Hyaluronic Acid", "Vitamin C", "Niacinamide"],
        benefits: [
        ...
        usage: "Apply 2-3 drops to clean skin, avoiding eye area. Start with every other day.",
        company: companies.find((c: any) => c.slug === "instapeels")?._id,
        category: categories.find(
      ...
      },
      {
        ...
        description: "Advanced pigmentation treatment for dark spots and uneven skin tone",
        price: 2199,
        discountPrice: 1759,
        image:
        ...
        stock: 25,
        sku: "IP-MP-003",
        ingredients: ["Alpha Arbutin", "Kojic Acid", "Vitamin C", "Licorice Extract"],
        benefits: [
          "Reduces dark spots",
          "Even skin tone",
          "Brightens complexion",
      ...
      // DermaFlay Products
      {
        ...
        description: "Ultra-gentle cleanser for sensitive skin with hydrating properties",
        price: 1299,
        discountPrice: 1039,
        image:
          "https://images.unsplash.com/photo-1556228720-195a672e8a03?w=400&h=400&fit=crop&crop=center",
        ...
        stock: 40,
        sku: "DF-GH-001",
        ingredients: ["Ceramides", "Hyaluronic Acid", "Chamomile Extract", "Aloe Vera"],
        benefits: [
          "Gentle cleansing",
        ...
        usage: "Massage onto wet skin, then rinse thoroughly with lukewarm water.",
        company: companies.find((c: any) => c.slug === "dermaflay")?._id,
        category: categories.find(
          (c: any) => c.slug === "sensitive-skin-care" && c.company?.slug === "dermaflay"
        )?._id,
        isActive: true,
      },
      {
        ...
        company: companies.find((c: any) => c.slug === "dermaflay")?._id,
        category: categories.find(
          (c: any) => c.slug === "anti-aging-solutions" && c.company?.slug === "dermaflay"
        )?._id,
        isActive: true,
      },
      ...
      // Vibrissa Products
      {
        ...
        description: "Pure, cold-pressed rosehip oil for natural skin nourishment",
        price: 899,
        discountPrice: 719,
        image:
          "https://images.unsplash.com/photo-1599305445771-384c3243a9d2?w=400&h=400&fit=crop&crop=center",
        ...
        stock: 60,
        sku: "VB-RH-001",
        ingredients: ["100% Rosehip Oil", "Vitamin A", "Vitamin C", "Essential Fatty Acids"],
        benefits: ["Moisturizes skin", "Reduces scars", "Anti-aging properties", "Natural glow"],
      ...
      },
      {
        ...
        description: "Gentle organic cleanser with antioxidant-rich green tea extract",
        price: 1199,
        discountPrice: 959,
        image:
          "https://images.unsplash.com/photo-1556228720-195a672e8a03?w=400&h=400&fit=crop&crop=center",
        ...
        stock: 45,
        sku: "VB-GT-002",
        ingredients: ["Organic Green Tea", "Aloe Vera", "Chamomile", "Natural Surfactants"],
        benefits: [
    ...
    for (const productData of products) {
      try {
        ...
        if (!productData.company || !productData.category) {
          errors.push(`Company or category not found for product: ${productData.name}`);
          continue;
        }
        ...
        if (existingProduct) {
          errors.push(`Product ${productData.name} already exists for this company`);
          continue;
        }
    ...
    return withCORS(NextResponse.json({ error: "Failed to setup products" }, { status: 500 }));
  }
}
