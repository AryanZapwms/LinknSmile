...
export default function SettingsPage() {
  ...
  return (
    <main className="bg-background min-h-screen">
      <div className="mx-auto max-w-4xl px-4 py-8">
        <h1 className="text-foreground mb-8 text-3xl font-bold">Payment Settings</h1>
          ...
          <CardContent className="space-y-8">
            ...
            <div className="space-y-4">
              <div className="border-border rounded-lg border p-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div className="flex-1">
                    <Label htmlFor="razorpay" className="cursor-pointer text-base font-semibold">
                      Razorpay
                    </Label>
              ...
              <div className="border-border rounded-lg border p-4">
                <div className="flex items-center space-x-3">
                  ...
                  />
                  <div className="flex-1">
                    <Label htmlFor="cod" className="cursor-pointer text-base font-semibold">
            ...
            <div className="rounded-lg border border-blue-200 bg-blue-50 p-4 text-sm">
              <p className="text-blue-900">
                <strong>Note:</strong> At least one payment method must be enabled for customers to
                make purchases.
              </p>
            </div>
          </CardContent>
