...
export default function AdminDashboard() {
  ...
  const topCategories = useMemo(
    () => analytics?.categoryPerformance.slice(0, 8) ?? [],
    [analytics]
  );
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground text-sm">
              Business performance overview for {dateRangeLabel}
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {numberFormatter.format(analytics.overview.totalOrders)}
              </div>
              <p className="text-muted-foreground text-xs">Orders in selected period</p>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              ...
              <MonitorDot className="text-muted-foreground h-4 w-4" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold">
                {numberFormatter.format(analytics.overview.totalProducts)}
              </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {numberFormatter.format(analytics.overview.totalUsers)}
              </div>
                ...
                {topCategories.map((category) => (
                  <div key={category.categoryName} className="flex items-center justify-between">
                    <div className="space-y-1">
                      <p className="text-sm leading-none font-medium">{category.categoryName}</p>
                ...
                {analytics.topProducts.slice(0, 5).map((product) => (
                  ...
                  >
                    <div>
                      ...
                      <p className="text-muted-foreground text-xs">Sold: {product.unitsSold}</p>
                    </div>
