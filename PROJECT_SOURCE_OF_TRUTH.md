...
4. **Two duplicate email-sending modules** (`lib/email.tsx`, `lib/EmailOtp.ts`) with inconsistent branding in templates ("LinkNSmile" vs "LinkAndSmile" vs legacy "Instapeels" domain links).
